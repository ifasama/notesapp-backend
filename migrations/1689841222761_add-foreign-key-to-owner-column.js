...
exports.up = (pgm) => {
  ...
  pgm.addConstraint('notes', 'fk.notes.owner_users.id', 'FOREIGN KEY(owner) REFERENCES users(id) ON DELETE CASCADE');
};

exports.down = (pgm) => {
  // menghapus constraint fk.notes.owner_users.id pada tabel notes
